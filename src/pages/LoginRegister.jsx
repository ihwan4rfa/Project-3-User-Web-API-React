...
const MainContent = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-screen font-montserrat bg-gradient-to-r from-slate-200 to-slate-100 dark:from-slate-800 dark:to-slate-700">
            <div className={`bg-white dark:bg-slate-900 rounded-[30px] translate-y-[4%] shadow-lg dark:shadow-slate-700 relative overflow-hidden w-1/2 max-w-full min-h-[400px] transition-all ease-in-out ${data.themeButtonClicked ? 'duration-0' : 'duration-300'} ${transitionOut ? 'opacity-0' : ''} ${transitionIn ? 'opacity-0' : ''}`}>
                ...
                <div className={`absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-all duration-500 ease-in-out z-30 ${btnClicked ? '-translate-x-[100%] rounded-r-[100px]' : 'translate-x-[0%] rounded-l-[100px]'}`}>
                    <div className={`bg-gradient-to-r from-blue-600 to-teal-600 h-full text-white relative -left-[100%] w-[200%] transition-all duration-500 ${btnClicked ? 'translate-x-[50%]' : 'translate-x-[0%]'}`}>
                        <div className="absolute w-1/2 h-full flex flex-col items-center justify-center px-[30px] text-center top-0 transition-all duration-500 ease-in-out translate-x-[0%]">
                            ...
                            <button onClick={toggleButton} className="text-white text-[12px] py-[10px] px-8 rounded-lg font-semibold tracking-tight uppercase mt-3 border hover:bg-white hover:text-blue-700">Log In</button>
                        </div>
                        <div className="absolute w-1/2 h-full flex flex-col items-center justify-center px-[30px] text-center top-0 transition-all duration-500 ease-in-out translate-x-[100%]">
                            ...
                            <button onClick={toggleButton} className="text-white text-[12px] py-[10px] px-8 rounded-lg font-semibold tracking-tight uppercase mt-3 border hover:bg-white hover:text-teal-700">Register</button>
                        </div>
                    </div>
                </div>
            </div>
